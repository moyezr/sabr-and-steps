...
ElevenLabs free-plan speech is eligible only for noncommercial auditions after a fresh authenticated balance check. The creator explicitly chooses the working speech provider and voice; there is no automatic provider or paid fallback.
